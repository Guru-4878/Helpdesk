...
export class DashboardComponent implements OnInit {
  ...
  constructor(private http: ApiSharedService, private constant: DashboardConstant, private formBuilder: FormBuilder, private toast: ToastrService,
    private User: UserProfile, private Global: GlobalUtils) {

    this.Empcode = this.User.getProfile().EmployeeCode;
    this.DepartmentId = +this.User.getProfile().DeptCode;
    console.log(this.User.getProfile().EmployeeCode);
    
    //this.Empcode = "AJP08491";
    //this.DepartmentId = 14;

    //this.Empcode = "AJP02028";
    //this.DepartmentId = 15;

    //this.Empcode = "AJP00145";
    //this.DepartmentId = 18;

    //this.Empcode = "AJP04851";
    //this.DepartmentId = 6;


  }
  //Encript(any) {
  //  return this.Global.EncriptTicketId(any);
  //}
  ngAfterViewInit() {
    // this.BindDashboard();
  ...
  BindDashboard() {
    ...
    console.log(this.User.getProfile().DeptCode);
